...
class Ui_Credits(object):
    ...
    def setup_Cred(self, MainWindow):
        ...
        Ui_Credits.list_widgets.append([self.centralwidget, 1])
        Ui_Credits.list_widgets.append([self.horizontalLayout_2, 2])
        Ui_Credits.list_widgets.append([self.horizontalLayout_3, 3])
        Ui_Credits.list_widgets.append([self.verticalLayout_2, 4])
        Ui_Credits.list_widgets.append([self.widget, 5])
        Ui_Credits.list_widgets.append([self.widget_2, 6])
        Ui_Credits.list_widgets.append([self.widget_3, 7])
