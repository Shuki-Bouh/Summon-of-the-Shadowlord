...
class Ui_PauseScreen(QMainWindow):
    ...
    def setup_Pause(self):
        ...
        Ui_PauseScreen.list_widgets.append([self.centralwidget, 1])
        Ui_PauseScreen.list_widgets.append([self.horizontalLayout, 2])
        Ui_PauseScreen.list_widgets.append([self.horizontalLayout_2, 3])
        Ui_PauseScreen.list_widgets.append([self.verticalLayout, 4])
        Ui_PauseScreen.list_widgets.append([self.widget, 5])
        Ui_PauseScreen.list_widgets.append([self.widget_2, 6])
        Ui_PauseScreen.list_widgets.append([self.widget_3, 7])
        ...
        Ui_PauseScreen.list_widgets.append([self.pushButton, 19])
