...
class Ui_Multi(object):
    ...
    def setup_Multi(self, MainWindow):
        ...
        Ui_Multi.list_widgets.append([self.horizontalLayout_2, 1])
        Ui_Multi.list_widgets.append([self.horizontalLayout_3, 2])
        Ui_Multi.list_widgets.append([self.verticalLayout_2, 3])
        Ui_Multi.list_widgets.append([self.widget, 4])
        Ui_Multi.list_widgets.append([self.widget_2, 5])
        Ui_Multi.list_widgets.append([self.widget_3, 6])
        Ui_Multi.list_widgets.append([self.centralwidget, 7])
